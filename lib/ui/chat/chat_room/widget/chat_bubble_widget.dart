...
class _ChatBubbleWidgetState extends State<ChatBubbleWidget> with BaseLayout {
  ...
  Widget _buildContent(ColorScheme colorScheme, bool isDarkMode) {
    ...
    final content = Column(
      crossAxisAlignment: hasReply ? CrossAxisAlignment.stretch : CrossAxisAlignment.end,
      mainAxisSize: MainAxisSize.min,
      children: [
        if (hasReply) ...[
              ...
              children: [
                ClipRRect(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    backgroundColor:
                        widget.isMe ? Colors.white.withValues(alpha: 0.24) : Colors.black.withValues(alpha: 0.08),
